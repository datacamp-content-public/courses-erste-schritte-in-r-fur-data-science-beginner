...
`@instructions`
Nachdem Sie sich nun um die Personaldaten gekümmert haben und Fehler behoben haben, sollen Sie Verkaufszeiten des neu administrierten Kundencenters analyisieren, da verschiedene Kunden sich über die Öffnungszeiten beschwert haben und wissen möchten, wann der längste Servicetag ist, um möglichst spät am Nachmittag Kontak. Des Weiteren sollen Sie prüfen, ob dieser Tag profitabel ist und sich die lange Öffnungszeit lohnt. 

...
`@instructions`
- 2. Es ist auf den Einkaufspreis von **295005€** im Dezember 2018 für die neuen Drohnenmotoren eine zusätzliche Marge in Höhe von **56050.95€** aufgeschlagen worden. Wie viel Prozent an zusätzlicher Marge wurde aufgeschlagen? Lassen Sie sich bitte das **Ergebnis in Prozent** ausgeben.
...
`@instructions`
Ist es richtig, dass das letzte Halbjahr 2018 erfolgreicher war als das Halbjahr 2019 sich zu entwickeln scheint, wie Herr Müller vermutet, da die Kunden mit dem Kauf der Paketdrohnen zögern und eine Reklamation sich in Q1 2019 sich auch negativ auf den Umsatz auswirkt?

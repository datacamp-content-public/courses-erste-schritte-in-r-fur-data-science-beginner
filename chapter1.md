...
Da verschiedene Kunden sich über die Öffnungszeiten beschwert haben und wissen möchten, wann der längste Servicetag ist. Des Weiteren sollen Sie prüfen, ob dieser Tag anhand von Kennzahlen profitabel ist und sich die lange Öffnungszeit auf Grundlage der letzten Umsatzzahlen lohnt. 
...
- 2. In dem Vektor **sell.time** ist die Servicezeit für jeden Tag hinterlegt. Lassen Sie sich bitte die Informationen über Typ und Struktur des Vektors **sell.time** ausgeben. Beurteilen Sie bitte, ob dieser nur numerische Zahlen enthält und welcher Servicetag der zeitlich längste ist.
...
`@instructions`
Herr Müller bittet Sie einen Wochenreport mit dem Namen **report.weeksales** für das Service- und Supportcenter zu erstellen.

...
- 2. In dem Vektor **sell.time** ist die Verkaufszeit für jeden Servicetag hinterlegt. Lassen Sie sich bitte die Informationen über Typ und Struktur des Vektors **sell.time** ausgeben. Beurteilen Sie bitte, ob dieser nur numerische Zahlen enthält und welcher Servicetag der zeitlich längste ist.
...
`@instructions`
Am längsten Arbeitstag im Kundencenter wurden in den letzten 12 Wochen durchschnittlich 52020€ Umsatz mit Support und Verkauf generiert. Wenn über 5000€ pro Umsatz pro Stunde generiert wird, lässt sich das Kundencenter als profitabel in dieser Branche ansehen. 
...
`@instructions`
- 4. Berechnen Sie bitte die durchschnittliche Verkaufs- und Servicezeit pro Arbeitstag in der Woche.
